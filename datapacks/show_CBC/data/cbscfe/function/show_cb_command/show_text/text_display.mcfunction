...
execute if score show_command show_cbc.setting matches 0 unless data block ~ ~ ~ CustomName run return 0
...
execute if score show_command show_cbc.setting matches 0 run return 0
