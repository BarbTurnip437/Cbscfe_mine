...
item replace entity @s hotbar.0 with minecraft:trident[unbreakable={}, enchantments={levels:{loyalty:5,vanishing_curse:1}}]
item replace entity @s hotbar.1 with minecraft:trident[unbreakable={}, enchantments={levels:{loyalty:5,vanishing_curse:1}}]
item replace entity @s hotbar.2 with minecraft:trident[unbreakable={}, enchantments={levels:{riptide:3,impaling:4,vanishing_curse:1}}]
