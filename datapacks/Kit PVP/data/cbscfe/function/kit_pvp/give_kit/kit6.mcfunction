...
give @s crossbow[unbreakable={},enchantments={levels:{"minecraft:quick_charge":3,vanishing_curse:1}},charged_projectiles=[{id:"minecraft:firework_rocket",count:1,components:{"minecraft:can_place_on":{predicates:[{blocks:"#axiom:existing"}],show_in_tooltip:false},"minecraft:fireworks":{flight_duration:-1,explosions:[{shape:"creeper",has_twinkle:true,has_trail:true,colors:[I;16763904],fade_colors:[I;6225664]},{shape:"creeper",has_twinkle:true,has_trail:true,colors:[I;16763904],fade_colors:[I;6225664]}]}}}]] 1
